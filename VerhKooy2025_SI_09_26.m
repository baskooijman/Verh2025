...
%For all 'Check' entries, source has not yet been examined 
  ...
  cho = { ... % Chondrichthyes, mass(g), temp(C), SMR(ml O2/min), MMR(ml O2/min), PMR.method
    ...
    %[10,700    20	     3.6319	15.5018]    'Loco.water', 'Nespoloetal2017', 'Dasyatis violacea' 
    [2000	    10	      0.54	1.4731]     'Loco.water', 'Nespoloetal2017', 'Squalus acanthias' 
  };
%prt_tab({cho(:,[3 2]), cell2mat(cho(:,1))},{'species', 'bibkey', 'mass,g', 'temp,C', 'SMR,ml O2/min', 'MMR,ml O2/min','PMR.method'}, 'Chondrich')
  ...
  %prt_tab({act(:,[3 2]), cell2mat(act(:,1))},{'species', 'bibkey', 'mass,g', 'temp,C', 'SMR,ml O2/min', 'MMR,ml O2/min','PMR.method'}, 'Actinop')
...
%  [30.7 20  0.0188	0.1361] 'Loco.land', 'Nespoloetal2017', 'Discoglossus_pictus' % 0.0063;0.0456 W
  ...
  %  [2.02 20  0.0024	0.0296] 'Loco.land', 'Nespoloetal2017', 'Dendrobates_auratus' % 0.0008;0.0099 W
   ...
   % [5 20  0.0027	0.0125] 'Loco.land', 'Nespoloetal2017', 'Osteopilus_septentrionaliss' % 0.0018;0.0182 W
...
[1.93	20	0.0012	0.0051] 'Loco.land', 'Nespoloetal2017', 'Geotrypetes_seraphini' %0.0004;0.0017 W
 ...
 %prt_tab({amp(:,[3 2]), cell2mat(amp(:,1))},{'species', 'bibkey', 'mass,g', 'temp,C', 'SMR,ml O2/min', 'MMR,ml O2/min','PMR.method'}, 'Amphib')


 squ = { ... % Squamata mass (g), Tb (C), SMR (mg O2/min), PMR (mg O2/min), PMRmethod
%Alligatoridae
...
[1136 		35   	NaN   	16.9]		 'Check', 'ChriConl1994', 'Cyclura_nubila'
%Phrynosomatidae
...
%Varanidae
%[1287 	35   	3.1   	24.3] 'Check', 'ChriConl1994', 'Varanus_rosenbergi' %x
%[1788.5	35	4.7325	30.9949]	'Loco.land', 'Nespolietal2017', 'Varanus_rosenbergi' %1.5854;10.3833 W
%[1086 	35   	1.9   	24.5] 'Check', 'ChriConl1994', 'Varanus_gouldii' %x
%[931 		35   	2.1   	20.8] 'Check', 'ChriConl1994', 'Varanus_panoptes' %x
%[ 904 		35   	1.2   	13.7] 'Check', 'ChriConl1994', 'Varanus_mertensi' %x
...
%Scincidae
[ 517  		35  	1.6    	5.4] 'Check', 'ChriConl1994', 'Tiliqua_rugosa'  
...
%prt_tab({squ(:,[3 2]), cell2mat(ave(:,1))},{'species', 'bibkey', 'mass,g', 'temp,C', 'SMR,ml O2/min', 'PMR,ml O2/min', 'PMR.method'}, 'Squ')
  ...
  ave = { ...  % Aves ; m(g) Tb(C) BMR(ml O2/min) PMR (ml O2/min), PMRmethod; %x means not in AmP
    ...
    [ 161.0 41.3  4.41  20.48]  'Loco.land', 'HindBaud1993', 'Coturnix_japonica'  
    [  42.1 40.5  1.20   6.57]  'Loco.land', 'HindBaud1993', 'Synoicus_chinensis' 
    [  42   40.5  1.46   3.40]  'Loco.land', 'FedaPins1974', 'Synoicus_chinensis' % 2.08 4.856 ml O2/h.g discard?? I don't think this is maximum CV
    [ 2800  41.0  24.1 299.60]  'Loco.land', 'BracElSa1985', 'Gallus_gallus_WL' % 8.6, 107 ml CO2/min.kg
    [ 4306  41.2  40.19 332.7]  'Loco.land', 'FedaPins1974', 'Meleagris_gallopavo' % 0.56 4.636 ml O2/h.gdiscard?? I don't think this is maximum CV
    [ 1207  40.7  21.12 92.70]  'Loco.land', 'FedaPins1974', 'Numida_meleagris' % 1.05 4.608 ml O2/h.g  discard?? I don't think this is maximum CV  
    [  489  40.7  11.00 34.66]  'Loco.land', 'FedaPins1974', 'Alectoris_graeca' % 1.35 4.253 ml O2/h.g discard?? I don't think this is maximum CV   
    [  194  38.9   4.33 11.97]  'Loco.land', 'FedaPins1974', 'Colinus_virginianus' % 1.34 3.703 ml O2/h.g discard?? I don't think this is maximum CV   
    % Anseriformes
    [275    4.12   NaN  23.22]  'Growth', 'Kirk1983',     'Dendrocygna_autumnalis' % PMR 672 kJ/d; 20.1 kJ/l O2
   %[ 944.1 39.7 12.23  61.51]  'Loco.land', 'HindBaud1993', 'Anas_castanea' %x
    [190    41.2   NaN  21.39]  'Growth', 'Kirk1983',     'Aythya_affinis' % PMR 619 kJ/d; 20.1 kJ/l O2
    [3813   41.2 40.03 197.51]  'Loco.land', 'FedaPins1974', 'Anser_anser' % 0.63 3.108 ml O2/h.g
    % Columbiformes
   %[ 302.0 41.7  4.34  28.24]  'Loco.land', 'HindBaud1993', 'Columba_livia' 
    [ 419   41.7  7.08  162.8]  'Check', 'Pear1964',     'Columba_livia' % PMR 112 kcal/h.kg (4.184 J/cal; 20.1 kJ/l O2); FAS 23 
    [40.5   42.1   NaN   8.54] 'Check', 'WierChap2007', 'Columbina_talpacoti' % PMR 2.86 W; 20.1 kJ/l O2
    % Gruiformes
    [ 850.3 37.4  9.19  52.08]  'Loco.land', 'HindBaud1993', 'Porphyrio_martinica' 
    % Apodiformes
    [ 5.7   40.7  0.051 0.717] 'Check', 'BergHart1972', 'Chionomesa_fimbriata' % PMR 43 ml/h.g, FAS 14
    [ 3.3   34    0.198 1.815] 'Check', 'Lasi1963',     'Archilochus_alexandri' % PMR 33 ml/h.g SMR 3.6 ml/h.g
    [ 4.1   39    0.232 9.157] 'Check', 'Lasi1963',     'Selasphorus_rufus' % PMR 124 ml/h.g SMR 3.4 ml/h.g
    [ 3.2   36.2  0.192 7.147] 'Check', 'Lasi1963',     'Selasphorus_sasin' % PMR 134 ml/h.g SMR 3.6 ml/h.g
    [ 2.3   36    0.153 2.542] 'Check', 'Lasi1963',     'Selasphorus_calliope' % PMR 66.3 ml/h.g SMR 4.0 ml/h.g
    [ 4.1   35.5  0.260 4.647] 'Check', 'Lasi1963',     'Calypte_anna' % PMR 68 ml/h.g SMR 3.8 ml/h.g
    [ 3.2   36.7  0.155 4.053] 'Check', 'Lasi1963',     'Calypte_costae' % PMR 76 ml/h.g SMR 2.9 ml/h.g
    [ 6.3   38.5  0.051 2.50 ] 'Check', 'SchuSchm1979', 'Trochilus_polytmus' % PMR 4.9 23.8 ml O2/h.g
    [ 4.9   41.4  0.054 1.89 ] 'Check', 'SchuSchm1979', 'Trochilus_scitulus' % PMR 6.6 23.1 ml O2/h.g
    [19.9   41.4  0.675 2.390] 'Check', 'LasiWeat1967', 'Patagona_gigas' % 2.131 7.547 ml O2/h.g
    [ 6.0   38.5  0.317 2.651], 'Check' 'RezeSwan2002', 'Sephanoides_sephaniodes' % 3.17 26.51 ml O2/h.g
    % Sphenisciformes
    [1080.0 38.5 13.31  57.42]  'Loco.land', 'HindBaud1993', 'Eudyptula_minor' 
    [45000  36.0 301.5   2340] 'Check', 'KooyPong1994', 'Aptenodytes_forsteri' % 6.7, 52 ml O2/min.kg
    [6210   38.2  59.2 219.46] 'Check', 'BevaWoak1995', 'Pygoscelis_papua' %  9.54, 35.34 ml O2/min.kg
    % Suliformes
    [1300   40.6   NaN  64.95]  'Growth', 'Kirk1983',     'Phalacrocorax_pelagicus' % PMR 1880 kJ/d; 20.1 kJ/l O2
    % Charadriiformes
    [277    40.9  8.13  45.97] 'Check', 'BernThom1973', 'Leucophaeus_atricilla' % 0.0099 0.056 W/g
    [63.4   41.0 1.409 16.906] 'Check', 'Putt1980',     'Calidris_ferruginea' % 1699 kJ/h; FAS 12; 20.1 kJ/l O2
    [58.4   41.0  1.94  10.41] 'Check', 'ThomSwan2019', 'Calidris_melanotos' % 
    [19.4   41.0  0.84   4.62] 'Check', 'ThomSwan2019', 'Calidris_minutilla' %  
    [16.0   41.0  1.38   3.19] 'Check', 'WillTiel2007', 'Calidris_minutilla' % 40.0 92.3 kJ/d; 20.1 kJ/l O2
    [41.1   41.0  3.02   7.71] 'Check', 'WillTiel2007', 'Calidris_alpina' % 87.45 223.11 kJ/d; 20.1 kJ/l O2
    [125.5  41.0  3.58  23.88] 'Check', 'VeziGers2017', 'Calidris_canutus' % 1.2 8.0 W; 20.1 kJ/l O2
    [61.0   41.0  3.63   8.62] 'Check', 'WillTiel2007', 'Tringa_flavipes' % 105.2 249.4 kJ/d; 20.1 kJ/l O2
    [55.0   41.0  2.38   7.60] 'Check', 'WillTiel2007', 'Limnodromus_griseus' % 68.88 220.04 kJ/d; 20.1 kJ/l O2
    [75.4   40.9  3.72  11.18] 'Check', 'WillTiel2007', 'Pluvialis_dominica' % 107.8 323.6 kJ/d; 20.1 kJ/l O2
    [151.0  41.0  7.08  16.41] 'Check', 'WillTiel2007', 'Limosa_haemastica' % 204.8 474.9 kJ/d; 20.1 kJ/l O2
    [190.0  41.0  7.79  23.38] 'Check', 'WillTiel2007', 'Numenius_phaeopus' % 225.6 676.6 kJ/d; 20.1 kJ/l O2
    % Ciconiiformes 
    [6000   40.5 52.37 178.05] 'Check', 'BamfMalo1980', 'Leptoptilos_crumeniferus' 
    % Strigiformes
    [ 76    41.0  1.86   8.85] 'Check', 'RezeSwan2002', 'Glaucidium_nana' % 1.47 6.67 ml O2/h.g; (weight 98 g is given, but 76 g is max)
    % Falconiformes
    [106    40.0   NaN  11.09]  'Growth', 'Kirk1983',     'Falco_tinnunculus' % PMR 321 kJ/d; 20.1 kJ/l O2
    % Piciformes
    [ 25    41.0  1.275  7.94] 'Check', 'RezeSwan2002', 'Dryobates_pubescens' % 3.06 19.05  ml O2/h.g
    [ 25.8  41.0   NaN   6.69] 'Check', 'SwanLikn2006', 'Leuconotopicus_villosus' % PMR 2.24 W; 20.1 kJ/l O2
    % Psittaciformes
    [89.4   40.0   NaN  12.79]  'Loco.land', 'HindBaud1993', 'Platycercus_elegans' % actually Platycercus_eximius
    [36.0   39.7  1.28   7.91]  'Loco.land', 'HindBaud1993', 'Melopsittacus_undulatus' % BundHopl1999 give AS 21
   %[12.0   41.6   NaN  11.91] 'Check', 'WierChap2007', 'Myiodynastes_maculatus' %x PMR 3.99 W; 20.1 kJ/l O2
    % Passeriformes
    % % Tyrannides
   %[27.5   41.6   NaN   6.27] 'Check', 'WierChap2007', 'Thamnophilus_doliatus' %x PMR 2.1 W; 20.1 kJ/l O2 Thamnophilidae
   %[22.5   41.3   NaN   6.00] 'Check', 'WierChap2007', 'Myrmeciza_longipes' %x PMR 2.01 W; 20.1 kJ/l O2 Thamnophilidae
   %[29.0   41.6   NaN   1.94] 'Check', 'WierChap2007', 'Myrmotherula_fulviventris' %x PMR 0.65 W; 20.1 kJ/l O2 Thamnophilidae
   %[12.0   41.1   NaN   1.46] 'Check', 'WierChap2007', 'Hylophylax_naevioides' %x PMR 0.49 W; 20.1 kJ/l O2 Thamnophilidae
   %[39.0   41.4   NaN   7.88] 'Check', 'WierChap2007', 'Sclerurus_guatemalensis' %x PMR 2.64 W; 20.1 kJ/l O2 Furnariidae
   %[27.9   41.6   NaN   9.55] 'Check', 'WierChap2007', 'Dendrocincla_fuliginosa' %x PMR 3.2 W; 20.1 kJ/l O2 Furnariidae
   %[10.8   41.5   NaN   4.21] 'Check', 'WierChap2007', 'Xenops_minutus' %x PMR 1.41 W; 20.1 kJ/l O2 Furnariidae  
    [18.5   41.6   NaN   6.03] 'Check', 'WierChap2007', 'Chiroxiphia_lanceolata' % PMR 2.02 W; 20.1 kJ/l O2 Pipridae
   %[12.3   41.6   NaN   4.96] 'Check', 'WierChap2007', 'Pipra_mentalis' %x PMR 1.66 W; 20.1 kJ/l O2 Pipridae
   %[18.2   41.6   NaN   4.48] 'Check', 'WierChap2007', 'Manacus_vitellinus' %x PMR 1.5 W; 20.1 kJ/l O2 Pipridae
    [42.0   41.6  1.491 8.183] 'Check', 'RezeSwan2002', 'Phytotoma_rara' % 2.13 11.69 ml O2/h.g Cotingidae
   %[ 9.0   41.6   NaN   1.40] 'Check', 'WierChap2007', 'Oncostoma_olivaceum' %x PMR 0.47 W; 20.1 kJ/l O2 Tyrannidae
   %[33.5   41.6   NaN   6.45] 'Check', 'WierChap2007', 'Elaenia_chiriquensis' %x PMR 2.16 W; 20.1 kJ/l O2 Tyrannidae
   %[ 7.0   41.6   NaN   2.45] 'Check', 'WierChap2007', 'Tyrannulus_elatus' %x PMR 0.82 W; 20.1 kJ/l O2 Tyrannidae
    [40.0   41.6   NaN   7.88] 'Check', 'WierChap2007', 'Tyrannus_melancholicus' %x PMR 2.64 W; 20.1 kJ/l O2 Tyrannidae
    [37.0   41.6 1.369  8.060] 'Check', 'RezeSwan2002', 'Tyrannus_tyrannus' %x PMR 2.22 13.07 ml O2/h.g O2 Tyrannidae
   %[25.7   40.7   NaN   3.16] 'Check', 'WierChap2007', 'Rhynchocyclus_olivaceus' %x PMR 1.06 W; 20.1 kJ/l O2 Tyrannidae
   %[ 6.5   41.6   NaN   2.87] 'Check', 'WierChap2007', 'Camptostoma_obsoletum' %x PMR 0.96 W; 20.1 kJ/l O2 Tyrannidae
   %[ 7.0   41.6   NaN   3.01] 'Check', 'WierChap2007', 'Capsiempis_flaveola' %x PMR 1.01 W; 20.1 kJ/l O2 Tyrannidae
   %[ 6.5   41.6   NaN   2.18] 'Check', 'WierChap2007', 'Todirostrum_cinereum' %x PMR 0.73 W; 20.1 kJ/l O2 Tyrannidae
    [46.5   41.6   NaN   6.30] 'Check', 'WierChap2007', 'Myiozetetes_similis' % PMR 2.11 W; 20.1 kJ/l O2 Tyrannidae
    [61.5   41.6   NaN   2.23] 'Check', 'WierChap2007', 'Mionectes_oleagineus' % PMR 0.75 W; 20.1 kJ/l O2 Tyrannidae
   %[14.5   41.6   NaN   4.18] 'Check', 'WierChap2007', 'Tolmomyias_assimillis' %x PMR 1.4 W; 20.1 kJ/l O2 Tyrannidae
    [14.0   41.6 0.642   3.87] 'Check', 'RezeSwan2002', 'Contopus_virens' %  2.75 16.57 ml O2/h.g  Tyrannidae
    [14.0   41.5 0.595  3.867] 'Check', 'DuteSwan1996', 'Contopus_virens' %  Tyrannidae
    [10.0   41.6   NaN   3.34] 'Check', 'WierChap2007', 'Myiobius_atricaudus' % PMR 1.12 W; 20.1 kJ/l O2 Onychorhynchidae
    % % Passeri
    [275    41.6 10.67  68.13] 'Check', 'BernThom1973', 'Corvus_ossifragus' % 0.013 0.083 W/g Corvidae
    [18.2   41.6   NaN   3.26]  'Activity', 'Kirk1983',     'Delichon_urbicum' % PMR 94.5 kJ/d; 20.1 kJ/l O2 Hirundinidae
   %[14.8   41.6   NaN  14.66] 'Check', 'WierChap2007', 'Mimus_gilvus' %x PMR 4.91 W; 20.1 kJ/l O2 Mimidae
    [34.0   41.6 1.552  8.149] 'Check', 'RezeSwan2002', 'Dumetella_carolinensis' % 2.74 14.38 cm^3 O2/h.g Mimidae
    [34.4   41.5 1.469  8.247] 'Check', 'DuteSwan1996', 'Dumetella_carolinensis' % Mimidae
    [35.4   41.5   NaN 10.209] 'Check', 'SwanLikn2006', 'Eremophila_alpestris' % PMR 3.42 W; 20.1 kJ/l O2 Alaudidae
    [13.5   41.9   NaN   9.04] 'Check', 'WierChap2007', 'Progne_chalybea' % PMR 3.03 W; 20.1 kJ/l O2 Hirundinidae
    [ 9.0   42.1   NaN   3.52] 'Check', 'WierChap2007', 'Tachycineta_albilinea' % PMR 1.18 W; 20.1 kJ/l O2 Hirundinidae
    [20.0   41.9 1.103  6.717] 'Check', 'RezeSwan2002', 'Sitta_carolinensis' % 3.31 20.15 ml O2/h.g Sittidae
   %[36.8   41.6   NaN   2.27] 'Check', 'WierChap2007', 'Ramphocaenus_melanurus' %x PMR 0.76 W; 20.1 kJ/l O2 Polioptilidae
   %[ 9.5   41.6   NaN   8.18] 'Check', 'WierChap2007', 'Ramphocelus_dimidiatus' %x PMR 2.74 W; 20.1 kJ/l O2 Polioptilidae
   %[24.5   41.6   NaN   5.19] 'Check', 'WierChap2007', 'Thryothorus_fasciatoventris' %x PMR 1.74 W; 20.1 kJ/l O2 Troglodytidae
   %[20.3   42.7   NaN   6.21] 'Check', 'WierChap2007', 'Thryothorus_leucotis' %x PMR 2.08 W; 20.1 kJ/l O2 Troglodytidae
   %[15.0   41.6   NaN   3.94] 'Check', 'WierChap2007', 'Thryothorus_rutilus' %x PMR 1.32 W; 20.1 kJ/l O2 Troglodytidae
    [13.5   42.0   NaN   5.28] 'Check', 'WierChap2007', 'Troglodytes_aedon' % PMR 1.77 W; 20.1 kJ/l O2 Troglodytidae
    [10.5   41.6 0.555  4.083] 'Check', 'DuteSwan1996', 'Troglodytes_aedon'  % Troglodytidae
    [11.0   41.6 0.422  2.867] 'Check', 'RezeSwan2002', 'Zosterops_lateralis' % 2.30 15.64 ml O2/h.g Zosteropidae
    [ 5.9   41.6   NaN  2.324] 'Check', 'RezeSwan2002', 'Corthylio_calendula'  % PMR 23.63 ml O2/h.g Regulidae
    [ 5.8   41.6   NaN  2.510] 'Check', 'RezeSwan2002', 'Regulus_satrapa'  % PMR 25.97 ml O2/h.g Regulidae
   %[72.0   42.1   NaN  15.19] 'Check', 'WierChap2007', 'Turdus_grayi' %x PMR 5.09 W; 20.1 kJ/l O2 Turdidae
   %[18.2   41.9   NaN   5.19] 'Check', 'WierChap2007', 'Vireo_flavoviridis' %x PMR 1.74 W; 20.1 kJ/l O2 Vireonidae
    [ 9.2   41.9   NaN  2.537] 'Check', 'SwanLikn2006', 'Vireo_bellii' % PMR 0.85 W; 20.1 kJ/l O2  Vireonidae
    [13.0   41.9 0.685  4.108] 'Check', 'RezeSwan2002', 'Vireo_gilvus' % 3.16 18.96 ml O2/h.g Vireonidae
   %[38.7   41.6   NaN   4.48] 'Check', 'WierChap2007', 'Hylophilus_flavipes' %x PMR 1.5 W; 20.1 kJ/l O2 Vireonidae
    [13.7   41.6 1.092  7.714] 'Check', 'DuteSwan1996', 'Poecile_atricapillus' % Paridae 
    [11.0   41.6 0.744  4.670] 'Check', 'RezeSwan2002', 'Poecile_gambeli' % 4.06 25.47 ml O2/h.g Paridae 
    % % % Passerida
    [11.3   41.0  0.68   4.03] 'Check', 'HindBaud1993', 'Taeniopygia_guttata' % Estrildidae
    [12.0   41.6 0.722  4.098] 'Check', 'RezeSwan2002', 'Taeniopygia_guttata' % 3.61 20.49 ml O2/h.g Estrildidae 
    [23.1   41.6  0.97   9.99] 'Check', 'ButtBech2010', 'Passer_domesticus' % for adults; juveniles 22.34 g, 1.06, 8.81 ml O2/min Passeridae
    [27.2   41.6 1.314 10.605] 'Check', 'DuteSwan1996', 'Passer_domesticus'  %  Passeridae 
   %[28.9   41.6   NaN   3.88] 'Check', 'WierChap2007', 'Euphonia_laniirostris' %x PMR 1.3 W; 20.1 kJ/l O2 Fringillidae
    [30.0   41.6   NaN   3.80]  'Cold',     'Kirk1983',     'Fringilla_coelebs' % PMR 110 kJ/d; 20.1 kJ/l O2 Fringillidae
    [20.8   41.6 0.971  2.392] 'Check', 'DawsButt1985', 'Haemorhous_mexicanus' % 2.8 6.9 cm^3 O2/h.g Fringillidae % cold stress down to 0C; at lower temp MR might be higher 
    [14.0   41.6 0.863  5.088] 'Check', 'RezeSwan2002', 'Acanthis_flammea' %  3.70 21.80  cm^3 O2/h.g Fringillidae
    [13.0   41.6 0.867  4.314] 'Check', 'RezeSwan2002', 'Spinus_tristis' % 4.0 19.91 cm^3 O2/h.g Fringillidae
    [40.7   41.6 1.564  8.922] 'Check', 'DuteSwan1996', 'Pheucticus_ludovicianus' % Cardinalidae 
   %[27.9   41.6   NaN   6.51] 'Check', 'WierChap2007', 'Cyanocompsa_cyanoides' %x PMR 2.18 W; 20.1 kJ/l O2 Cardinalidae
   %[13.2   41.6   NaN   7.97] 'Check', 'WierChap2007', 'Habia_fuscicauda' %x PMR 2.67 W; 20.1 kJ/l O2 Cardinalidae
    [46.0   41.6 NaN    9.721] 'Check', 'RezeSwan2002', 'Cardinalis_cardinalis' % 12.68 cm^3 O2/h.g Cardinalidae
    [13.9   41.6 NaN    3.881] 'Check', 'SwanLikn2006', 'Passerina_cyanea' % 1.3 W; 20.1 kJ/l O2 Cardinalidae
   %[27.0   41.6   NaN   6.21] 'Check', 'RezeSwan2002', 'Phrygilus_gayi' %x PMR 13.80 ml O2/h.g Thraupidae
   %[ 7.5   41.6   NaN   4.09] 'Check', 'WierChap2007', 'Oryzoborus_angolensis' %x PMR 1.37 W; 20.1 kJ/l O2 Thraupidae
   %[21.8   41.6   NaN   8.24] 'Check', 'WierChap2007', 'Eucometis_penicillata' %x PMR 2.76 W; 20.1 kJ/l O2 Thraupidae
   %[39.0   41.6   NaN   7.79] 'Check', 'WierChap2007', 'Saltator_striatipectus' %x PMR 2.61 W; 20.1 kJ/l O2 Thraupidae
   %[36.5   41.6   NaN   4.09] 'Check', 'WierChap2007', 'Sporophila_americana' %x PMR 1.37 W; 20.1 kJ/l O2 Thraupidae
   %[10.1   41.6   NaN   4.39] 'Check', 'WierChap2007', 'Sporophila_nigricollis' %x PMR 1.47 W; 20.1 kJ/l O2 Thraupidae
    [29.7   41.3   NaN   7.28] 'Check', 'WierChap2007', 'Thraupis_episcopus' % PMR 2.44 W; 20.1 kJ/l O2 Thraupidae
   %[30.5   41.6   NaN   6.42] 'Check', 'WierChap2007', 'Thraupis_palmarum' %x PMR 2.15 W; 20.1 kJ/l O2 Thraupidae
    [34.0   41.6  NaN   9.100] 'Check', 'RezeSwan2002', 'Diuca_diuca' % 16.06 cm^3 O2/h.g Thraupidae
   %[41.2   41.6   NaN   9.91] 'Check', 'WierChap2007', 'Arremonops_conirostris' %x PMR 3.32 W; 20.1 kJ/l O2 Passerellidae
    [32.4   41.6   NaN   4.46]  'Fattening',         'Kirk1983',     'Zonotrichia_leucophrys' % PMR 129 kJ/d; 20.1 kJ/l O2 Passerellidae
    [28.0   41.6   NaN   4.91]  'Cold',         'Kirk1983',     'Zonotrichia_albicollis' % PMR 142 kJ/d; 20.1 kJ/l O2 Passerellidae
    [20.0   41.6 1.037  5.433] 'Check', 'RezeSwan2002', 'Zonotrichia_capensis' % 3.11 16.30 ml O2/h.g Passerellidae
    [12.8   41.6 0.722  4.539] 'Check', 'DuteSwan1996', 'Spizella_pusilla' % Passerellidae
    [18.6   41.6 1.209  7.478] 'Check', 'DuteSwan1996', 'Spizelloides_arborea' % Passerellidae
    [20.0   41.6 1.423  8.619] 'Check', 'DuteSwan1996', 'Junco_hyemalis' % Passerellidae   
    [17.0   41.6 0.941  5.879] 'Check', 'RezeSwan2002', 'Junco_hyemalis' % 3.32 20.75 ml O2/h.g Passerellidae   
    [19.0   41.6 1.311  7.638] 'Check', 'RezeSwan2002', 'Spizelloides_arborea' % 4.14 24.12 ml O2/h.g Passerellidae   
    [11.0   41.6 0.638  3.584] 'Check', 'RezeSwan2002', 'Spizella_passerina' % 3.48 19.55 ml O2/h.g Passerellidae   
    [13.0   41.6 0.789  4.611] 'Check', 'RezeSwan2002', 'Spizella_pusilla' % 3.64 21.28 ml O2/h.g Passerellidae   
   %[11.0   41.6   NaN   3.52] 'Check', 'WierChap2007', 'Basileuterus_rufifrons' %x PMR 1.18 W; 20.1 kJ/l O2 Parulidae
    [ 9.3   41.6 0.546  3.018] 'Check', 'DuteSwan1996', 'Setophaga_petechia' % Parulidae
    [ 9.0   41.6 0.744  3.894] 'Check', 'RezeSwan2002', 'Setophaga_petechia' % 3.72 19.47 cm^3 O2/h.g Parulidae
    [12.0   41.6 0.746  3.937] 'Check', 'RezeSwan2002', 'Setophaga_coronata' % 3.73 19.69 cm^3 O2/h.g Parulidae
    [32.0   41.6 1.499  7.242] 'Check', 'RezeSwan2002', 'Icterus_galbula' % 2.81 13.58 cm^3 O2/h.g Icteridae
    [20.4   41.6  NaN   5.015] 'Check', 'SwanLikn2006', 'Icterus_spurius' % 1.68 W; 20.1 kJ/l O2 Icteridae
};     
  %prt_tab({ave(:,[3 2]), cell2mat(ave(:,1))},{'species', 'bibkey', 'mass,g', 'temp,C', 'SMR,ml O2/min', 'PMR,ml O2/min', 'PMRmethod'}, 'Aves')

  mar = { ... % Marsupialia & Prototheria; m(g), Tb(C), BMR(ml O2/min), PMR (ml O2/min), PMR.method; %x means not in AmP
   % Prototheria
    [ 1112.5 30.8 10.87  49.86] 'Check', 'HindBaud1993', 'Ornithorhynchus_anatinus' 
    [ 3293.0 30.8  7.76  47.05] 'Check', 'HindBaud1993', 'Tachyglossus_aculeatus' 
    [ 3900.0 30.8  9.75  91.00] 'Check', 'HampNels2010', 'Tachyglossus_aculeatus' % 0.15 1.4 ml O2/h.g
   % Marsupialia
    [   15.6 35.0  0.48   2.38] 'Check', 'HindBaud1993', 'Sminthopsis_crassicaudata' 
    [   16.7 32.7  0.35   2.38] 'Check', 'HindBaud1993', 'Sminthopsis_macroura'
    [  119.5 35.3  1.52  19.36] 'Check', 'HindBaud1993', 'Dasyuroides_byrnei'
    [  532.3 33.7  3.20  29.85] 'Check', 'HindBaud1993', 'Dasyurus_hallucatus'
    [ 1054.0 35.1  6.28  69.60] 'Check', 'HindBaud1993', 'Dasyurus_viverrinus' 
    [  717.2 33.9  3.71  43.43] 'Check', 'HindBaud1993', 'Isoodon_obesulus'
    [  837.3 35.2  7.01  48.76] 'Check', 'HindBaud1993', 'Perameles_gunnii'
    [  122.0 34.9  1.40   8.24] 'Check', 'HindBaud1993', 'Petaurus_breviceps' 
    [  965.7 37.2  9.39  70.07] 'Check', 'HindBaud1993', 'Bettongia_penicillata'
    [ 1385.0 35.6 10.69 100.10] 'Check', 'HindBaud1993', 'Bettongia_gaimardi' 
    [ 1027.8 35.8  8.72  65.90] 'Check', 'HindBaud1993', 'Potorous_tridactylus' 
    [ 2026.5 35.8 13.85  74.65] 'Check', 'HindBaud1993', 'Trichosurus_vulpecula'
    [   34   30   21.42  70.04]  'Check','WithThom2000', 'Notoryctes_caurinus' % 0.63 2.06 mL O2/h.g
  };
  %  
  pla = {... % Placentalia; m(g), Tb(C), BMR(ml O2/min), PMR (ml O2/min), PMR.method; %x means not in AmP
   % Eulipotyphla
    [    3.3 39.0  0.15   1.60] 'Check', 'Lech1978',     'Sorex_cinereus'
    [   8.2  39.6 0.803   3.21] 'Check', 'OchoTayl2005', 'Sorex_araneus' % BMR 58.1/2.5 kJ/d; PMR 23.5 ml O2/h.g; 20.1 kJ/l O2
   % Carnivora
   %[  583   39.8   NaN   74.4] 'Check', 'TaylMalo1980', 'Helogale_parvula' %x 1.24 ml O2/s
   %[ 1151   39.8   NaN  139.8] 'Check', 'TaylMalo1980', 'Mungos_mungo' %x 2.33 ml O2/s
   %[ 1458   36.7   NaN  154.8] 'Check', 'TaylMalo1980', 'Genetta_tigrina' %x 2.58 ml O2/s
    [ 41000  39.0 311.2  14700] 'Check', 'ScanMill2014', 'Acinonyx_jubatus' % FMR=DEE 9006 kJ/d PMR 120 W/kg; 20.1 kJ/l O2
    [ 25000  38.0 117.5   2900] 'Check', 'GormMill1998', 'Canis_familiaris' % BMR 3.4 MJ/d canid AS 25; 20.1 kJ/l O2
    [450000  36.8   NaN   5782] 'Check', 'Kirk1983',     'Ursus_maritimus' % PMR 167360 kJ/d; 20.1 kJ/l O2
    [    86  39.6   NaN   7.34] 'Check', 'Kirk1983',     'Mustela_nivalis' % PMR 224 kJ/d; 20.1 kJ/l O2
    [   63e3 37   289.8    945] 'Check', 'DaviWill1985', 'Phoca_vitulina' % 4.6 15 ml O2/min.kg   
   % Perissodactyla
    [500000  38.0  1600  88000] 'Check', 'Hodg2025',     'Equus_ferus_caballus' % BMR 2.2-4.2 mL O2/kg/min; FAS 50-60
   %[635000  38.0   NaN   4957] 'Check', 'Kirk1983',     'Equus_ferus_caballus' % PMR 143470 kJ/d; 20.1 kJ/l O2. Reliable? PMR is less than for a cow
   % Cetartiodactyla
    [205000  39.0   NaN   2371] 'Check', 'Kirk1983',     'Sus_domesticus' % PMR 68620 kJ/d; 20.1 kJ/l O2 
   %[ 3500   36.7   NaN  355.2] 'Check', 'TaylMalo1980', 'Nesotragus_moschatus' %x 5.92 ml O2/s
    [ 4354   39.4   NaN  237.0] 'Check', 'TaylMalo1980', 'Madoqua_kirkii' % 3.95 ml O2/s
   %[11200   38.9   NaN  600.0] 'Check', 'TaylMalo1980', 'Gazella_granti' %x 10.0 ml O2/s
    [32000   39.5 152.5   9792] 'Check', 'LindHoka1991', 'Antilocapra_americana' % 5.1 ml O2/s.kg = 9792 ml O2/min; Bish1999 FAS 64.2; BMR 9792/64.2 ml O2/min
    [98000   38.0   NaN  4356 ] 'Check', 'TaylMalo1980', 'Connochaetes_taurinus' % 72.6 ml O2/s
    [114000  39.4   NaN  5388 ] 'Check', 'TaylMalo1980', 'Kobus_ellipsiprymnus' % 89.8 ml O2/s
    [217000  36.5   NaN  7860 ] 'Check', 'TaylMalo1980', 'Taurotragus_oryx' % 131 ml O2/s
    [ 21150  39.3   NaN  1098 ] 'Check', 'TaylMalo1980', 'Capra_hircus' % 18.3 ml O2/s
    [ 22650  38.8   NaN  1050 ] 'Check', 'TaylMalo1980', 'Ovis_aries' % 17.5 ml O2/s
    [550000  38.6   NaN   6082] 'Check', 'Kirk1983',     'Bos_primigenius_Holstein' % PMR 176040 kJ/d; 20.1 kJ/l O2 (milk production)
    [  817e3 35.5  3315  10897] 'Check', 'JohnChri2024', 'Delphinapterus_leucas' % 4.058 13.338 ml O2/min.kg
    [5.318e6 36.0  6633  39635] 'Check', 'WortWort2013', 'Orcinus_orca' % 8.0 47.8 MJ/h; 20.1 kJ/l O2 
   % Rodentia
   %[   255  39.0 2.928  29.88] 'Check', 'Bozi1992',     'Microcavia_niata' %x 175.7 1792.7 ml O2/h
   %[    35  39.6 1.030   5.35] 'Check', 'Bozi1992',     'Abrothrix_andinus' %x 61.8 321.1 ml O2/h
   %[    29  39.6 0.877   6.91] 'Check', 'Bozi1992',     'Abrothrix_andinus' %x 52.6 414.6 ml O2/h
   %[    25  39.6 0.660   6.11] 'Check', 'Bozi1992',     'Abrothrix_andinus' %x 39.6 366.6 ml O2/h
   %[    33  39.6 0.977   5.92] 'Check', 'Bozi1992',     'Abrothrix_andinus' %x 58.6 355.3 ml O2/h
   %[    23  39.6 0.735   4.87] 'Check', 'Bozi1992',     'Abrothrix_andinus' %x 44.1 292.3 ml O2/h
   %[    42  39.6 1.308   6.09] 'Check', 'Bozi1992',     'Abrothrix_longipilis' %x 78.5 365.4 ml O2/h
   %[    27  39.6 0.823   4.14] 'Check', 'Bozi1992',     'Abrothrix_olivaceus' %x 49.4 248.4 ml O2/h
   %[    24  39.6 0.760   5.00] 'Check', 'Bozi1992',     'Abrothrix_lanosus' %x 45.6 300.0 ml O2/h
   %[    31  36.2 0.775   6.10] 'Check', 'Bozi1992',     'Akodon_albiventer' %x 46.5 365.8 ml O2/h
   %[    77  39.6 1.848   9.75] 'Check', 'Bozi1992',     'Auliscomys_boliviensis' %x 110.9 585.2 ml O2/h
    [    62  39.6 1.622   7.44] 'Check', 'Bozi1992',     'Loxodontomys_micropus' % 97.3 446.4 ml O2/h
    [     7  36.0 0.333   1.44] 'Check', 'Bozi1992',     'Baiomys_taylori' %  20.0 86.1 ml O2/h
    [    48  36.6 1.183   5.44] 'Check', 'Bozi1992',     'Calomys_callosus' % 71.0 326.4 ml O2/h
    [    48  38.0  0.93   5.34] 'Check', 'Lech1978',     'Calomys_callosus'
    [    16  36.6 0.480   3.73] 'Check', 'Bozi1992',     'Calomys_lepidus' % 28.8 224.0 ml O2/h
    [    17  36.6 0.468   3.00] 'Check', 'Bozi1992',     'Calomys_musculinus' % 28.1 180.2 ml O2/h
    [    28  36.6 1.283   6.30] 'Check', 'Bozi1992',     'Myodes_rutilus' % 77.0 378.0 ml O2/h
    [    15  36.6 0.813   6.60] 'Check', 'Bozi1992',     'Myodes_rutilus' % 48.8 396.0 ml O2/h
    [    21  39.6 0.560   6.66] 'Check', 'Bozi1992',     'Eligmodontia_typus' % 33.6 399.6 ml O2/h
    [    18  39.6 0.513   3.45] 'Check', 'Bozi1992',     'Eligmodontia_typus' % 30.8 207.0 ml O2/h
   %[    69  39.6 1.392   7.25] 'Check', 'Bozi1992',     'Graomys_griseoflavus' %x 83.5 434.7 ml O2/h
   %[    28  36.2 0.845   4.57] 'Check', 'Bozi1992',     'Oryzomys_longicaudatus' %x 50.7 274.4 ml O2/h
    [    32  38.4 1.280   6.67] 'Check', 'Bozi1992',     'Microtus_oeconomus' % 76.8 400.0 ml O2/h
    [    41  36.4 0.941   3.48] 'Check', 'Bozi1992',     'Peromyscus_californicus' % 56.5 208.9 ml O2/h
    [    18  36.6 0.405   2.41] 'Check', 'Bozi1992',     'Peromyscus_eremicus' % 24.3 144.3 ml O2/h
    [    19  36.6 0.448   2.41] 'Check', 'Bozi1992',     'Peromyscus_eremicus' % 26.9 144.4 ml O2/h
    [  17.3  36.6 1.510   4.15] 'Check', 'Haye2010',     'Peromyscus_maniculatus' % 4.45 mL CO2/h.g, 0.24 ml O2/min.g; 0.85 mL CO2/mL O2
    [    49  39.6 1.093   5.86] 'Check', 'Bozi1992',     'Phyllotis_darwini' % 65.6 351.4 ml O2/h
    [    59  39.6 1.190   6.79] 'Check', 'Bozi1992',     'Phyllotis_darwini' % 71.4 407.1 ml O2/h
    [    36  39.6 0.757   5.15] 'Check', 'Bozi1992',     'Phyllotis_darwini' % 45.4 308.9 ml O2/h
   %[    79  39.6 1.280   9.48] 'Check', 'Bozi1992',     'Reithrodon_auritus' %x 76.8 569.0 ml O2/h
    [    33  37.0 0.772   3.79] 'Check', 'Bozi1992',     'Dipodomys_merriami' % 46.3 227.5 ml O2/h
    [    34  37.0 0.627   4.29] 'Check', 'Bozi1992',     'Dipodomys_merriami' % 37.6 257.5 ml O2/h
    [    45  39.6 0.835   3.34] 'Check', 'Bozi1992',     'Heteromys_salvini' % 50.1 200.3 ml O2/h
   %[    20  34.7 0.397   2.84] 'Check', 'Bozi1992',     'Perognathus_fallax' % 23.8 170.2 ml O2/h
   %[    21  34.7 0.463   2.78] 'Check', 'Bozi1992',     'Perognathus_fallax' % 27.8 166.6 ml O2/h
   %[    18  34.7 0.425   2.56] 'Check', 'Bozi1992',     'Perognathus_fallax' % 25.5 147.5 ml O2/h
   %[   176  37.6 3.053  12.91] 'Check', 'Bozi1992',     'Octodon_bridgesi' %x 183.2 774.4 ml O2/h
    [   195  37.6 3.023  17.88] 'Check', 'Bozi1992',     'Octodon_degus' % 181.4 1072.5 ml O2/h
   %[   173  37.6 2.855  15.28] 'Check', 'Bozi1992',     'Octodon_lunatus' %x 171.3 916.9 ml O2/h
    [   28.0 37.0  1.28   6.30] 'Check', 'Lech1978',     'Myodes_rutilus'
    [    6.9 36.0  0.24   1.41] 'Check', 'Lech1978',     'Baiomys_taylori'
    [  113   38.0  2.47  11.20] 'Check', 'Lech1978',     'Mesocricetus_auratus'
   %[  819.0 34.6  9.51  44.27] 'Check', 'HindBaud1993', 'Uromys_caudimaculatus' %x
    [  212.3 35.9  2.71  14.85] 'Check', 'HindBaud1993', 'Conilurus_penicillatus' 
    [   38.8 36.2  0.83   3.48] 'Check', 'HindBaud1993', 'Notomys_alexis'
    [    17  36.9 0.502   3.91] 'Check', 'Bozi1992',     'Mus_musculus' % 30.1 234.6 ml O2/h
    [    17  36.9 0.500   3.49] 'Check', 'Bozi1992',     'Mus_musculus' % 30.0 209.1 ml O2/h
    [   34   37.0  0.88   5.30] 'Check', 'Lech1978',     'Mus_musculus'
    [   253  37.0 4.470  21.93] 'Check', 'Bozi1992',     'Rattus_norvegicus' % 268.2 1315.6 ml O2/h
    [  181.2 38.0  4.47  21.90] 'Check', 'Lech1978',     'Rattus_norvegicus' 
   %[  165.7 36.2  2.05  11.51] 'Check', 'HindBaud1993', 'Rattus_colletti' %x
   %[  247.8 36.0  2.43  14.48] 'Check', 'HindBaud1993', 'Rattus_villosissimus' %x
    [ 3200.0 37.0  10.1  80.00] 'Check', 'HampNels2010', 'Marmota_marmota' %  0.19 1.5 ml O2/h.g 
    [  800.0 35.5  6.67  35.33] 'Check', 'HampNels2010', 'Urocitellus_parryii' % 0.5 2.65 ml O2/h.g 
    [  240.0 35.5  4.47  21.90] 'Check', 'HampNels2010', 'Ictidomys_tridecemlineatus' % 0.96 4.7 ml O2/h.g 
   % Lagomorpha
    [ 1242.0 38.3  8.84  18.8] 'Check', 'HindBaud1993', 'Oryctolagus_cuniculus'
   % Primates
    [70000   37.0 268.3   3733] 'Check', 'WillSton2005', 'Homo_sapiens' % 0.23, 3.2 ml O2/h.g
 };               
  %prt_tab({[mar(:,[3 2]);pla(:,[3 2])], [cell2mat(mar(:,1));cell2mat(pla(:,1))]},{'species', 'bibkey', 'mass,g', 'temp,C', 'SMR,ml O2/min', 'PMR,ml O2/min', 'PMRmethod'}, 'Mammalia')
