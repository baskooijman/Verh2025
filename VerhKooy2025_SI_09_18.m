...
if ~exist('fig','var')
  ...
  act = { ... % Actinopterygii, mass(g), temp(C), SMR(ml O2/min), PMR(ml O2/min), MMR(ml O2/min) 
    ...
    [258	18	0.3926	    1.3055	 NaN	],	'Sandblometal2016','Perca_fluviatilis'	%  91.3;MMR:303.6 mg/kg/hr
    [285	23	0.5282	1.7095	NaN	], 'Sandblometal2016','Perca_fluviatilis'		% 111.2 ;MMR: 359.8mg/kg/hr
    [285	15	0.0550	0.1904	NaN	], 'Verhilleetal2016','Oncorhynchus_mykiss'		% 2.03 ;MMR: 7.03 mgkg^-0.95/min
  };
