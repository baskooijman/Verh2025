...
ave = { ...  % Aves ; m(g) Tb(C) BMR(ml O2/min) PMR (ml O2/min), PMRmethod; %x means not in AmP
   ...
   % [ 419   41.7  7.08  162.8]  'Check', 'Pear1964',     'Columba_livia' % PMR 112 kcal/h.kg (4.184 J/cal; 20.1 kJ/l O2); FAS 23; omit metabolism based on weight loss not oxygen consumption
  ...
  %  [1300   40.6   NaN  64.95]  'EnergyIntake', 'Kirk1983',     'Phalacrocorax_pelagicus' % PMR 1880 kJ/d; 20.1 kJ/l O2
   ...
   % [63.4   41.0 1.409 16.906] 'Check', 'Putt1980',     'Calidris_ferruginea' % 1699 kJ/h; FAS 12; 20.1 kJ/l O2; discard for now metabolism based on activity and feeding observations not O2 concumption
 ...
 [13.36   42.1   NaN   4.15] 'Cold', 'WierChap2007', 'Tachycineta_albilinea' % PMR 1.39 W; 20.1 kJ/l O2 Hirundinidae
   ...
   %[ 24.75   41.6   NaN   3.13] 'Check', 'WierChap2007', 'Ramphocelus_dimidiatus' %x PMR 1.05 W; 20.1 kJ/l O2 Polioptilidae
 ...
 pla = {... % Placentalia; m(g), Tb(C), BMR(ml O2/min), PMR (ml O2/min), PMR.method; %x means not in AmP
   % Eulipotyphla
    ...
    [   8.2  39.6 0.745   2.26] 'Check', 'OchoTayl2005', 'Sorex_araneus' % BMR 58.1/2.5 kJ/d; PMR 18.08 ml O2/h.g; 20.1 kJ/l O2
 ...
 %   [5.318e6 36.0  6633  39635] 'Check', 'WortWort2013', 'Orcinus_orca' % 8.0 47.8 MJ/h; 20.1 kJ/l O2 Omit PMR is estimates based on activity observations
   % Rodentia
