...
%CEV needs to run at beginning
  PATH_SEP = pathsep();
    wget_path = '/opt/homebrew/bin/wget'; % Or wherever wget is installed
    currPath = getenv('PATH');
    setenv('PATH', [currPath, PATH_SEP, wget_path]);
...
PMR.method = ['Loco.land','Loco.water','Loco.fly', 'Loco.flyburst', 'DEEModel', 'EnergyIntake', 'Turpor.arousal', 'Digest', 'Righting','Cold','Check'];
...
prt_tab({cho(:,[4 3 2]), cell2mat(cho(:,1))},{'species', 'bibkey', 'PMR.method','mass,g', 'temp,C', 'SMR,ml O2/min', 'MMR,ml O2/min'}, 'Chondrich')
  ...
  %prt_tab({act(:,[4 3 2]), cell2mat(act(:,1))},{'species', 'bibkey', 'PMR.method','mass,g', 'temp,C', 'SMR,ml O2/min', 'MMR,ml O2/min'}, 'Actinop')
...
%[1.93	20	0.0012	0.0051] 'Loco.land', 'Nespoloetal2017', 'Geotrypetes_seraphini' %0.0004;0.0017 W
 ...
 %prt_tab({amp(:,[4 3 2]), cell2mat(amp(:,1))},{'species', 'bibkey', 'PMR.method','mass,g', 'temp,C', 'SMR,ml O2/min', 'MMR,ml O2/min'}, 'Amphib')
...
%prt_tab({squ(:,[4 3 2]), cell2mat(ave(:,1))},{'species', 'bibkey', 'PMR.method','mass,g', 'temp,C', 'SMR,ml O2/min', 'PMR,ml O2/min'}, 'Squ')


  ave = { ...  % Aves ; m(g) Tb(C) BMR(ml O2/min) PMR (ml O2/min), PMR.method; %x means not in AmP
    % Casuariiformes
    ...
    % Anseriformes
    %[275    4.12   NaN  23.22]  'EnergyIntake', 'Kirk1983',     'Dendrocygna_autumnalis' % PMR 672 kJ/d; 20.1 kJ/l O2
   %[ 944.1 39.7 12.23  61.51]  'Cold', 'HindBaud1993', 'Anas_castanea' %x
    %[190    41.2   NaN  21.39]  'EnergyIntake', 'Kirk1983',     'Aythya_affinis' % PMR 619 kJ/d; 20.1 kJ/l O2
   ...
   %[ 302.0 41.7  4.34  28.24]  'Cold', 'HindBaud1993', 'Columba_livia' 
    ...
    % Suliformes
    [1300   40.6   NaN  64.95]  'EnergyIntake', 'Kirk1983',     'Phalacrocorax_pelagicus' % PMR 1880 kJ/d; 20.1 kJ/l O2
    % Charadriiformes
    ...
    % Falconiformes
    [106    40.0   NaN  11.09]  'EnergyIntake', 'Kirk1983',     'Falco_tinnunculus' % PMR 321 kJ/d; 20.1 kJ/l O2
    % Piciformes
   ...
   %[14.5   41.6   NaN   4.18] 'Check', 'WierChap2007', 'Tolmomyias_assimillis' %x PMR 1.4 W; 20.1 kJ/l O2 Tyrannidae
    ...
    [18.2   41.6   NaN   3.26]  'EnergyIntake', 'Kirk1983',     'Delichon_urbicum' % PMR 94.5 kJ/d; 20.1 kJ/l O2 Hirundinidae
   ...
   %[28.9   41.6   NaN   3.88] 'Check', 'WierChap2007', 'Euphonia_laniirostris' %x PMR 1.3 W; 20.1 kJ/l O2 Fringillidae
    [30.0   41.6   NaN   3.80]  'EnergyIntake',     'Kirk1983',     'Fringilla_coelebs' % PMR 110 kJ/d; 20.1 kJ/l O2 Fringillidae
   ...
   %[41.2   41.6   NaN   9.91] 'Check', 'WierChap2007', 'Arremonops_conirostris' %x PMR 3.32 W; 20.1 kJ/l O2 Passerellidae
    [32.4   41.6   NaN   4.46]  'EnergyIntake',         'Kirk1983',     'Zonotrichia_leucophrys' % PMR 129 kJ/d; 20.1 kJ/l O2 Passerellidae
    [28.0   41.6   NaN   4.91]  'EnergyIntake',         'Kirk1983',     'Zonotrichia_albicollis' % PMR 142 kJ/d; 20.1 kJ/l O2 Passerellidae
  ...
  %prt_tab({ave(:,[4 3 2]), cell2mat(ave(:,1))},{'species', 'bibkey', 'PMR.method','mass,g', 'temp,C', 'SMR,ml O2/min', 'PMR,ml O2/min'}, 'Aves')
  ...
  mar = { ... % Marsupialia & Prototheria; m(g), Tb(C), BMR(ml O2/min), PMR (ml O2/min), PMR.method; %x means not in AmP
   ...
   % Marsupialia
    ...
    [ 1613 3.6 12.96 230.89] 'Loco.land', 'HindBaud1993', 'Bettongia_gaimardi' 
  ...
  pla = {... % Placentalia; m(g), Tb(C), BMR(ml O2/min), PMR (ml O2/min), PMR.method; %x means not in AmP
   ...
   %[ 25000  38.0 117.5   2900] 'DEEModel', 'GormMill1998', 'Canis_familiaris' % BMR 3.4 MJ/d canid AS 25; 20.1 kJ/l O2
    [450000  36.8   NaN   5782] 'EnergyIntake', 'Kirk1983',     'Ursus_maritimus' % PMR 167360 kJ/d; 20.1 kJ/l O2
    [    86  39.6   NaN   7.34] 'EnergyIntake', 'Kirk1983',     'Mustela_nivalis' % PMR 224 kJ/d; 20.1 kJ/l O2
   ...
   %[635000  38.0   NaN   4957] 'EnergyIntake', 'Kirk1983',     'Equus_ferus_caballus' % PMR 143470 kJ/d; 20.1 kJ/l O2. Reliable? PMR is less than for a cow
   % Cetartiodactyla
    [205000  39.0   NaN   2371] 'EnergyIntake', 'Kirk1983',     'Sus_domesticus' % PMR 68620 kJ/d; 20.1 kJ/l O2 
   ...
   %[11200   38.9   NaN  600.0] 'Check', 'TaylMalo1980', 'Gazella_granti' %x 10.0 ml O2/s
    ...
    [550000  38.6   NaN   6082] 'EnergyIntake', 'Kirk1983',     'Bos_primigenius_Holstein' % PMR 176040 kJ/d; 20.1 kJ/l O2 (milk production)
   ...
   %[    28  36.2 0.845   4.57] 'Cold', 'Bozi1992',     'Oryzomys_longicaudatus' %x 50.7 274.4 ml O2/h
   ...
   %[    20  34.7 0.397   2.84] 'Cold', 'Bozi1992',     'Perognathus_fallax' % 23.8 170.2 ml O2/h
   %[    21  34.7 0.463   2.78] 'Cold', 'Bozi1992',     'Perognathus_fallax' % 27.8 166.6 ml O2/h
   %[    18  34.7 0.425   2.56] 'Cold', 'Bozi1992',     'Perognathus_fallax' % 25.5 147.5 ml O2/h
   %[   176  37.6 3.053  12.91] 'Cold', 'Bozi1992',     'Octodon_bridgesi' %x 183.2 774.4 ml O2/h
   ...
   % Lagomorpha
    [ 1242.0 38.3  8.84  18.8] 'Cold', 'HindBaud1993', 'Oryctolagus_cuniculus'
   % Primates
